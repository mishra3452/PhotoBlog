...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText reg_email_field;//email edit text
    private EditText reg_pass_field; //password edit text
    private EditText reg_confirm_pass_field; //confirm password edit text
    private Button reg_btn; //register button
    private Button reg_login_btn; //login button
    private ProgressBar reg_progress; //progress Bar
